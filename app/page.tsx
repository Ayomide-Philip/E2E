...
export default function Home() {
  ...
  return (
    <div className="h-screen w-full bg-linear-to-br from-black via-zinc-950 to-black overflow-hidden">
      <div
        className="absolute inset-0 bg-linear-to-br from-black via-zinc-950 to-black"
        style={{
          backgroundImage:
      ...
      <div className="relative z-10 flex items-center justify-center h-[calc(100vh-73px)] px-4">
        <div className="max-w-5xl w-full">
          <div className="relative h-full min-h-0 flex items-center justify-center">
            ...
            >
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-2xl shadow-lg p-3 max-w-47.5 border border-zinc-800">
            ...
            >
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-2xl shadow-lg p-4 max-w-55 border border-zinc-800">
                <div className="text-xs font-semibold text-white mb-2">
                  ✓ Room Created
                </div>
                <p className="text-[11px] leading-snug text-zinc-400 mb-3">
            ...
            <motion.div
              ...
              variants={floatingVariants}
            >
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-2xl shadow-lg p-3 max-w-52.5 border border-zinc-800">
                <div className="text-xs font-semibold text-white mb-1">
                  🗑️ Auto-Delete
                </div>
                <p className="text-[11px] leading-snug text-zinc-400">
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-5 leading-[1.02] tracking-tight">
              ...
              <p className="text-sm md:text-base text-zinc-400 mb-8 max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                <motion.button
                  ...
                  className="bg-white text-black px-7 py-3.5 rounded-xl font-semibold text-sm md:text-base hover:bg-zinc-100 transition-all duration-300 hover:shadow-xl hover:shadow-white/20"
                ...
                <motion.button
                  ...
                  className="border-2 border-zinc-700 text-white px-7 py-3.5 rounded-xl font-semibold text-sm md:text-base hover:bg-zinc-900/50 hover:border-zinc-600 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Learn More
